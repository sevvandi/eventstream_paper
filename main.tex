...
\captionsetup[algorithm]{style=italic,format=hang,singlelinecheck=true}
...
\begin{align}
	...
	\text{with} \qquad Z_{t_1} & = \left[ \bm{1} \, \, \bm{P}_{t_1} \right] \, , \label{eq:OurMod1}
\end{align}
...
We use developing-events classifiers and cascaded state space models to classify events in synthetic and real data streams.
