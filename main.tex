...
Fundamentally, this problem can be tackled by embedding age-varying coefficients in a learned model \cite{hastie1993varying}. A linear model with age-varying coefficients is given by
